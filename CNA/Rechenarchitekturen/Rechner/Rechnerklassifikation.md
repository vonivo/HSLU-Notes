Rechner werden nach Flynn in 4 Kategorien unterteilt:
![[ClassificationFlynn.png]]

|                   | Single Instruction                                                                                                                                                                | Multiple Instruction                                                                                                                                                    |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Single Data**   | **SISD**<br>(Single-Instruction Single-Data)<br>Klassischer [[CNA/Rechenarchitekturen/Rechner/Rechner\|Prozessor]].<br>[[Von-Neuman-Architektur]] oder [[Harvard Architektur]]<br>                                | **MISD**<br>(Multiple-Instruction-Singel-Data)<br>redundante Systeme,<br>Paralleles Berechnen von Alternativen (Sachcomputer, teilw. auch: Pipelinerechner)<br><br><br> |
