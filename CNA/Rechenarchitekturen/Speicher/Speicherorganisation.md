...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| < 1ns                 | Register ([[CNA/Rechenarchitekturen/Speicher/RAM#SRAM = Static RAM\|SRAM]])                                                                                              | einige Bytes bis kByte |
| 2ns                   | Cache ([[CNA/Rechenarchitekturen/Speicher/RAM#SRAM = Static RAM\|SRAM]])                                                                                                 | 0.5 - 256 MB           |
| 5-10 ns               | Arbeitspeicher ([[CNA/Rechenarchitekturen/Speicher/RAM#DRAM = Dynamic RAM\|DRAM]])                                                                                       | 4-384 GB               |
